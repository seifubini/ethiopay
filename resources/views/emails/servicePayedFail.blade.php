...
<html lang="en">
    <head>
        <head>
            <title>{{ config('ethiopay.EMAIL.SUBJECT_PRE_TEXT') . 'Service Payed Fail' }}</title>
        </head>
    </head>
    <body>
        @include('emails.include.header')
            ...
            <div style="width:80%; margin: 0 auto; padding: 29px 0 0;">
                    <h1 style="color:#484848; font-size:30px; font-weight: bold; margin:0;">You there was an error in the payment processing
                        </h1>
            </div>
        </div>
        <div style="margin: 47px 45px 0;">
            <table width="100%" height="100%" cellpaddign="10" cellspacing="0" border="0">
                    <tr style="">
                        <td style="">
                            <a href="#" style="display: inline-block; text-decoration: none;"><img src="{{ asset('img/emails/cancel.png') }}" alt=""></a>
                        </td>
                        <td style="padding-left:37px; vertical-align: top;">
                            <p style="font-size:14px; color:#484848; line-height: 24px; margin: 0;font-weight:regular;">Lorem ipsum dolor sit amet, consectertur adipiscing elit. Duis sit amet dignissim diam. Proin maximus augue eget lorem gravida.
                            </p>
                        </td>
                    </tr>
            </table>
            <table width="100%" height="100%" cellpaddign="10" cellspacing="0" style="border:3px solid #CFCFCF; margin: 37px 0 27px;">
                ...
                <tr style="">
                    <td style="padding:15px;color:#484848;font-size:18px; font-weight:regular;">Error</td>
                    <td style="padding:15px;color:#484848;font-size:18px; font-weight: bold;">{{ ((array) json_decode($transaction->stripe_transaction_response))['message'] }}</td>
                </tr>
                {{-- <tr style="background-color:#d34e52;">
                    <td style="padding:15px;color:#FFF;font-size:18px; font-weight: bold;">Error</td>
                    <td style="padding:15px;color:#FFF;font-size:22px; font-weight:bold;">${{ $transaction->total_pay_amount }}</td>
                </tr> --}}
                <tr style="background-color:#d34e52;">
                    <td style="padding:15px;color:#FFF;font-size:18px; font-weight: bold;">Amount</td>
                    <td style="padding:15px;color:#FFF;font-size:22px; font-weight:bold;">${{ number_format($transaction->total_pay_amount, 2) }}</td>
                </tr>
            </table>
            ...
            <p style="color: #484848; font-size: 14px; line-height: 25px; font-weight:regular;">Roin maximus augue eget lorem gravida, non eleifend mi cursus.</p>                        
            {{-- <p style="color: #484848; font-size: 14px; line-height: 25px; font-weight:regular;">To view all your past service payments, click the link below.</p>             --}}
            {{-- <div style="text-align: center;"><a href="{{ url("transaction") }}" style=" font-size:14px; font-weight: bold; background-color: #d34e52; border-radius: 4px; display: inline-block; padding: 16px 70px; text-decoration: none; color:white;">SERVICE PAYMENTS</a></div>            
