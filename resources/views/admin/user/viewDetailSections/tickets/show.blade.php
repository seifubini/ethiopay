...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ url("admin/users/$user->id/tickets") }}">Tickets</a>
            </li>
            <li>
                @yield('title')
            </li>
                    ...
                    <div class="comment-form">
                        <form action="javascript:void(0);" class="form" id="postComment">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ url("admin/users/$user->id/tickets") }}" class="btn btn-primary">Back</a>                                  
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function postComment() {
        ...
        $.ajax({
            type: "POST",
            url: "{{ url('admin/users') }}/" + {{ $user->id }} + "/comment",
            dataType: 'json',
    ...
    function comment(){
        $.ajax({
            url: "{{ url('admin/users') }}/" + {{ $user->id }} + "/get-comment/" + "{{ $ticket->ticket_id }}",
            method: 'GET',
