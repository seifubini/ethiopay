        ...
        <div class="col-lg-12 col-md-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    {!! Form::open(['url' => 'admin/users', 'method' => 'POST',"enctype"=>"multipart/form-data",'class'=>'form-horizontal','id'=>'userform']) !!}
    ...
    $(document).ready(function () {
        ...
        $("#userform").validate({
            ...
            errorPlacement: function (error, element) {
                {{--  if (element.attr('class') == 'form-control chosen-select has-error') {
                    error.insertAfter($(element).after().next());
                }  --}}
