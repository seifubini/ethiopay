        ...
        <div class="col-lg-12 col-md-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="uidLookupAddForm" name="uidLookupAddForm" class="form-horizontal" method="POST" action="{{ url('admin/uid-lookup') }}">
                        {{ csrf_field() }}
                            ...
                            <div class="col-lg-6">
                                <select id="service_type_id" name="service_type_id" class="form-control">
                                    ...
                                    @foreach($serviceType as $s)
                                        <option value="{{ $s->id }}" {{ old('service_type_id') == $s->id ? 'selected' : '' }} >{{ $s->service_name }}</option>
                                    @endforeach
                                </select>
                                @if($errors)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input id="uid" name="uid" type="text" class="form-control" value="{{ old('uid') }}">
                                @if($errors)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input id="debtor_firstname" name="debtor_firstname" type="text" class="form-control" value="{{ old('debtor_firstname') }}">
                                @if($errors)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input id="debtor_lastname" name="debtor_lastname" type="text" class="form-control" value="{{ old('debtor_lastname') }}">
                                @if($errors)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input id="debtor_city" name="debtor_city" type="text" class="form-control" value="{{ old('debtor_city') }}">
                                @if($errors)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class='input-group col-lg-12' id='datepicker'>
                                    <input type='text' name="cut_off_date" id="cut_off_date" class="form-control" id="date" value="{{ old('cut_off_date') }}"/>
...
<script type="text/javascript">
    ...
    $('#uidLookupAddForm #datepicker').datetimepicker({
        "locale": "en",
        "format":"YYYY-MM-DD",
        defaultDate: addCurrentUtcDateObj.format('YYYY-MM-DD'),
    });

    $("#uidLookupAddForm").validate({
        ignore: [],
        errorElement: 'div',
