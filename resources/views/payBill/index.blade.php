            ...
            <div class="tabular-main">
                <form name="payBillForm" id="payBillForm" action="javascript:void(0);">
                    ...
                    <div class="tab-content">
                        <div id="customer-info" class="tab-pane fade in active tab-content-detail">
                            <div class="row">
                                <div class="col-md-5">
                        ...
                        <div id="invoice-details" class="tab-pane fade tab-content-detail">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="payment-info">
                                        <i class="utility-img"></i>
                                    ...
                                    <div class="invoice-form customer-form">
                                        <div class="input-box">
                                            ...
                                            <div class="invoice-detail">
                                                <!--<p>Name<span id="selected_service_provider_name"></span></p>-->
                                                <p>Name<span id="debtor_name"></span></p>
<!--                                                <p>City<span>{{ ($address) ? $address->cityData->name : 'N/A' }}</span></p>-->
                                                <p>City<span id="debtor_city"></span></p>
                                                <!--<p>Period<span>January 02 - February 02</span></p>-->
                                            ...
                                            <div class="invoice-detail">
                                                <!--                                                <div class="amtblk">
                                                                                                    <p>Amount</p>
                                                                                                    <div class="amtinputblk">
                                                                                                        <span>$</span><input id="payBillAmount" name="payBillAmount" type="text" />
                                                                                                    </div> 
                                                                                                </div>-->
                                            ...
                                            <div class="invoice-detail callblk clearfix">
                                                <div class="phblk">
                                                    <!--<label for="debtor_phone_number">PHONE NUMBER</label>-->
                        ...
                        <div id="payment_method-selection" class="tab-pane fade tab-content-detail">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="payment-info">
                                        <i class="utility-img"></i>
                                ...
                                <div class="col-md-7">
                                    <div class="payment-select customer-form">
                                        <div id="paymentMethodContainer" class="flex-box">
                                            ...
                                            @endforeach
                                            <!--                                            <div class="singlePaymentMethodSection payment-select-detail" paymentMethodId="5">
                                                                                            <div class="payment-flex">
                                                                                                <img src="{{ asset('img/mastercard.png') }}" height="26px">
                                                                                                <h3>Bank of America</h3>
                                                                                                <h4>Credit Card</h4>
                                                                                                <h5>XXXX-8041</h5>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="singlePaymentMethodSection payment-select-detail" paymentMethodId="5">
                                                                                            <div class="payment-flex">
                                                                                                ...
                                                                                                <h3>Bank of America</h3>
                                                                                                <h4>alex@getkeyapp.com</h4>
                                                                                                <h5>Verified</h5>
                                                                                            </div>
                                                                                        </div>-->
                                        </div>
                                        <!--<label id="paymentMethodId-error" class="error hide" for="paymentMethodId">Please select payment method.</label>-->
...
//    $('#payBillAmount').keypress(function (event) {
...
//                    fnToastError(payBillResponse.message);
                }
            },
            error: function (xhr, status, error) {
                $('#payBillForm_submitBtn').button('reset')
