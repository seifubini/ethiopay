	...
	function Constellation (canvas, options) {
		...
		this.bind = function () {
			$window
				...
				.on('touchstart', this.handlers.window.touchstart)
				.on('touchmove', this.handlers.window.touchmove)
		...
		this.unbind = function () {
			$window
				...
				.off('touchstart', this.handlers.window.touchstart)
				.off('touchmove', this.handlers.window.touchmove)
